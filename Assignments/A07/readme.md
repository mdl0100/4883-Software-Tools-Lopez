...
|   #   | File | Description     |
| :---: | ---- | --------------- |
|   1   | [pycache](./__pycache__/)             | Generated by virtual environment |
...
|   8   | [__main.py__](./main.py)                      | The python program to run get user data, scrape the website and present the GUI    |
